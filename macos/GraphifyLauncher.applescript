on run
  ...
  set runCmd to "cd " & quoted form of repoRoot & " && " & quoted form of nativeRunner & space & quoted form of targetPosix & space & quoted form of modeArg & " > " & quoted form of logPath & " 2>&1"
